...
public class PrepUsersDriver {
    public static void main(String[] args) throws Exception {
        ...
        FileOutputFormat.setOutputPath(job, new Path(outputPath + "/tmp_Preprocess_Users"));

        job.waitForCompletion(true);

        copyFile(outputPath + "/tmp_Preprocess_Users/part-r-00000", outputPath + "/users.txt");
        deletePath(outputPath + "/tmp_Preprocess_Users", true);
    }
