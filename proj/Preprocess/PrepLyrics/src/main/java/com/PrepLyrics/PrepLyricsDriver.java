...
public class PrepLyricsDriver {
    public static void main(String[] args) throws Exception {
        ...
        FileOutputFormat.setOutputPath(job, new Path(outputPath + "/tmp_Preprocess_Lyrics"));

        job.waitForCompletion(true);

        copyFile(outputPath + "/tmp_Preprocess_Lyrics/part-r-00000", outputPath + "/lyrics.txt");
        deletePath(outputPath + "/tmp_Preprocess_Lyrics", true);
    }
