...
public class DurationDriver {
    public static void main(String[] args) throws Exception {
        ...
        Job job = Job.getInstance(conf, "Analyze Song Duration");
        ...
        copyFile(outputPath + "/tmp_Analyze_Song_Duration/part-r-00000", outputPath + "/task23.txt");
        deletePath(outputPath + "/tmp_Analyze_Song_Duration", true);
    }
